	...
	//Fecha: 24/09/2019
	//Tabla de Operaciones con posibilidad de  finalización de Programa
	...
	Proceso  TablaDeOperaciones
		...
		Leer opción;
		Si opción<=4 y opción>=1 Entonces
			...
			Fin Si
		SiNo
			Si opción>=5 o opción<=8 o opción>=10 Entonces
				Escribir "Error en la selección de operación.";
				Escribir "";
			SiNo
